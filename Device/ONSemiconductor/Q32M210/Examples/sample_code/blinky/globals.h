 ...
 * approximately 6.0 s assuming a system clock of 3.0 MHz and a timer clock
 * prescaler of 128. */
 ...
 *
 * The calculated count value would be 140625.
 * However, the timeout value is only 12-bits. So the maximum it can represent
 * is:
 *      2^12 - 1 = 4095
 *
 * To calculate the number of times Timer0 needs to "time out" before 6 seconds
 * has passed, the following calculation is made:
 *
 *      140625 / 750 = 188
 *
 * In order to blink the LEDs every 6 seconds, it would be 225 timeouts.
 * This logic can be seen in the Timer0 int_handler. */
#define TIMER0_TIMEOUT_VALUE        (750)
#define TIMER0_INTS_PER_TIMEOUT     (188)
...
/* Definitions for LEDs to blink on & off */
