...
/* I2C configuration - master mode, DMA controled, stop interrupt enabled
 * Auto ack must be disabled in master mode. */
#define I2C_CTRL_CFG                (I2C_MASTER_SPEED_12  | \
                                     I2C_CONTROLLER_CM3   | \
...
#define I2C_PHYSICAL_CTRL_CFG       (I2C_PULLUP_1K        | \
                                     I2C_FILTER_DISABLE)
...
#define I2C_CONTROL_STATE_IDLE                    0
#define I2C_CONTROL_STATE_SEND_CMD                1
#define I2C_CONTROL_STATE_WAIT_FOR_STOP           2
#define I2C_CONTROL_STATE_SEND_DATA               3
#define I2C_CONTROL_STATE_GET_DATA                4


/* State constants stored in I2C_Control_Status */
#define I2C_CONTROL_TRANSACTION_NOT_STARTED     0x00
#define I2C_CONTROL_TRANSACTION_PENDING         0x01
#define I2C_CONTROL_TRANSACTION_COMPLETE        0x02
#define I2C_CONTROL_TRANSACTION_INCOMPLETE      0x03
...
extern unsigned int I2C_Control_Status;
...
extern unsigned int I2C_ACK_received;
extern unsigned int GPIO_event_flag;
