...
static uint8_t descConfiguration[DESC_CONFIG_LENGTH] =
{
    ...
    0xC0,                   /* Configuration characteristics - self powered */
 ...
 * ----------------------------------------------------------------------------
 * Description   : Clears the USB status on reset. Initialize system and USB
 *                 core. Ready and wait for endpoint 4 to receive transfer
 *                 information.
 * Inputs        : None
 * Outputs       : None
 * Assumptions   : None
