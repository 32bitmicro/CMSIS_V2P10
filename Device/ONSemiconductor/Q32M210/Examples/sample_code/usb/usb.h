...
#define PRODUCT_ID                  0x2003  /* CFG: Product ID */
...
#define MANUFACTURER_STRING_LENGTH  0x22    /* CFG: Length of manufacturing
                                             * string descriptor */
#define PRODUCT_STRING_LENGTH       0x10    /* CFG: Length of product string
                                             * descriptor */

#define HID_REPORT_SIZE             16      /* CFG: Report size in bytes 
                                             * (1-63) */
