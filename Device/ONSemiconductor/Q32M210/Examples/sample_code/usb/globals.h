...
/* DMA clock divisor to 1 */
#define DMA_CLK_DIV_CFG             DMA_CLK_DIV_1_BYTE
...
/* Output enable config - enable GPIOs 4 to 11 as outputs to drive the LEDs */
#define GPIO_IF4_OUTPUT_ENABLE_CFG  0x00000FF0

/* Pull-down configuration - enable pulldowns on GPIOs 12 and 13 to use 
 * buttons */
#define GPIO_IF4_PULLDOWN_CFG       0x00003000
...
/* Reset the USB core and enable it for later use
 * Configure USB core to use CM3 for data transfer */
#define USB_CFG                    (USB_RESET_ENABLE | \
                                    USB_ENABLE | \
                                    USB_CONTROLLER_CM3)
...
#define INITIATE_READ               (0x00)

#define INITIATE_WRITE              (0x01)

#define DMA_WRITE_TRANSFER          (0x02)
